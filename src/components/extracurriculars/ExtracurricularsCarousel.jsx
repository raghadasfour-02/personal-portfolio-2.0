  ...
  return (
    <div className='carousel_container'>
        <Carousel breakPoints={breakPoints}>
          <Item>
            <small> <b>Quantum Mechanics Talk</b><br></br> <br></br>
            I got the privilege of giving a TED-ed Talk about quantum mechanics. I chose to focus this talk on the double slit experiment to spark an interest in the audience  about the elegance of the world of quantum mechanics. 
          ...
          <Item>
          <small><b>Hosting the Largest Student-run Conference in Canada</b>
            <br></br> <br></br>
            As the Glenforest STEM president, I got the priveledge of leading a team of bright, hard-working individuals that are looking to spread their &hearts; for STEM. <br></br> <br></br>
          ...
          <Item>
            <small><b>My Love for the Theatrical Arts</b>
            <br></br> <br></br>
